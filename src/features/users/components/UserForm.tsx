    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      {!isEdit && (
        <div>
          ...
          <select
            name="id_karyawan"
            required
            className="mt-1 block w-full rounded-md border border-gray-300 p-2 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm bg-white"
      ...
      <div>
        ...
        <select
          ...
          onChange={handleChange}
        >
          <option value="sales">Sales (Mobile Only)</option>
