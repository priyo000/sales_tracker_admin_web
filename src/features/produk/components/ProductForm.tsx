    ...
    <form onSubmit={handleSubmit} className="space-y-6 py-2">
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
          ...
          <FormField label="SKU / Barcode" icon={Package} required>
            <Input
              required
              className="h-9 bg-card border-border focus-visible:ring-primary shadow-sm font-semibold rounded-lg"
              value={formData.sku}
        ...
        <FormField label="Nama Produk Lengkap" icon={Tag} required>
          <Input
            required
            className="h-9 bg-card border-border focus-visible:ring-primary shadow-sm font-semibold rounded-lg"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
          <FormField label="Kategori Produk" icon={Tag} required>
            <Select
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
          <FormField 
            ...
            icon={Banknote} 
            required
            description="Harga dasar yang ditampilkan ke sales."
          >
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[10px] font-bold text-muted-foreground uppercase opacity-80">
                Rp
              </span>
              <Input
                type="number"
                required
                className="h-9 pl-10 bg-card border-border focus-visible:ring-primary shadow-sm font-semibold rounded-lg"
          ...
          <FormField label="Stok Tersedia" icon={Database} required>
            <Input
              type="number"
              required
              className="h-9 bg-card border-border focus-visible:ring-primary shadow-sm font-semibold rounded-lg"
      ...
      <div className="flex items-center justify-end gap-3 pt-4 border-t">
        ...
        <Button
          type="submit"
          disabled={isLoading}
          className="h-9 px-10 text-[10px] font-bold uppercase tracking-wider shadow-lg shadow-primary/20 bg-primary hover:bg-primary/90 text-white rounded-lg transition-all hover:scale-[1.02]"
        >
          {isLoading ? (
